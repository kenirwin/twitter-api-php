...
- [Create a twitter app on the twitter developer site](https://developer.twitter.com/en/apps)
- Enable read/write access for your twitter app
- Grab your access tokens from the twitter developer site
- [Choose a twitter API URL to make the request to](https://developer.twitter.com/en/docs/api-reference-index)
